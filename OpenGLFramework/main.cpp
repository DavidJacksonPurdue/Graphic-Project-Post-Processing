...
void display()
{
	...
	projMatrix = glm::perspective(glm::radians(45.0f), windowWidth / windowHeight, 3.5f, 7.0f);
...
void init()
{
	...
	typeLoc = glGetUniformLocation(postShaderProgram, "shade_type");
